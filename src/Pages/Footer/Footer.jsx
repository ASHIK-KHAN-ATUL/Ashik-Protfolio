  ...
  return (
    <footer className="bg-gradient-to-bl from-purple-600/20 via-indigo-500/10 to-sky-500/20  text-gray-300 px-5 md:px-20 py-12 mt-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="/" className="hover:text-[#0EA5E9] duration-300">
                Home
              </a>
            </li>
            <li>
              <a href="/about" className="hover:text-[#0EA5E9] duration-300">
                About
              </a>
            </li>
            <li>
              <a href="/project" className="hover:text-[#0EA5E9] duration-300">
                Projects
              </a>
            </li>
            <li>
              <a href="/contact" className="hover:text-[#0EA5E9] duration-300">
                Contact
              </a>
            </li>
          </ul>
      ...
      <div className="mt-10 text-center text-sm text-purple-500 border-t border-gray-700 pt-4">
        ...
        <NavLink to={"/login-register"}>Ashik Khan</NavLink>. All Rights
        Reserved.
      </div>
    </footer>
  );
