      ...
      <div className="flex justify-between items-center">
        <div>
          <span className="text-3xl font-bold">
            ASHIK
            <span className="text-xs font-extralight text-gray-400/35 md:ml-2">
              v3.8.7
            </span>
          </span>
        </div>
        ...
        <div className="hidden lg:block">
          <ul className="flex gap-5  font-semibold">
            ...
            {isAdmin && (
              <NavLink to={"/dashboard/add-project"} className={"nav-link"}>
                <li>DashBoard</li>
              </NavLink>
            )}
          </ul>
            ...
            >
              <ul className=" flex flex-col  w-[60vh] text-start ">
                <NavLink
                  to={"/"}
                  className={
                    "hover:bg-gradient-to-br from-sky-400/20 via-indigo-500/30 to-purple-600/20 duration-500 p-2 rounded-sm w-auto"
                  }
                >
                  <li>Home</li>
                </NavLink>
                ...
                {user?.email && (
                  <li>
                    <button
                      ...
                      className="font-bold cursor-pointer p-2 hover:bg-gradient-to-br from-sky-400/20 via-indigo-500/30 to-purple-600/20 rounded-sm w-auto text-red-500"
                    >
                      {" "}
                      Logout
                    </button>
