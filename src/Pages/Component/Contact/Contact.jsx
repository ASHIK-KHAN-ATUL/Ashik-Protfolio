...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axiosPublic.post('/send-message', contactMessage)
        .then(res =>{
    ...
    return (
        <div className=" px-4 md:px-20 py-10  ">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gradient-to-bl from-purple-600/30 via-indigo-500/20 to-sky-500/30  border  border-y-purple-500/70 border-x-sky-500/70 p-10 rounded-lg">
                <input
                    type="text"
                    name='name'
